...
class ADODB_Pager {
	...
	var $gridAttributes = 'style="color: green;" width=100% border=1 #000000 solid bgcolor=white';
	...
	{
		echo "<table ".$attributes."><tr align='center' style='background:green; color:white' ><td>",
				$header,
			"</td></tr>
			<tr><td>",
				$grid,
			"</td></tr>
			<tr align='center' style='background:green; color:white'><td>",
				$footer,
			"</td></tr></table>";
	}
}
