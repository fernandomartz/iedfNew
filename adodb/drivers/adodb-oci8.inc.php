...
*/
	function _connect($argHostname, $argUsername, $argPassword, $argDatabasename,$mode=0)
	{
		...
		if ($mode==1)
		{
			$this->_connectionID = OCIPLogon($argUsername,$argPassword, $argDatabasename, $this->charSet);
			if ($this->_connectionID &amp;&amp; $this->autoRollback) OCIrollback($this->_connectionID);
		}
		else if ($mode==2)
		{
			$this->_connectionID = OCINLogon($argUsername,$argPassword, $argDatabasename, $this->charSet);
		}
		else
		{
			$this->_connectionID =
