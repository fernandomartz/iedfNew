...
var url = cadena+".php?distrito="+distrito+"&seccion="+seccion+"&dato="+dato+"&ram="+ran+"&tipo="+tipo+"&anio="+an;
//alert("2 "+url);
xmlhttp.open("GET",url,true);
xmlhttp.send();
}
...
function loadXMLDoc4(seccion, distrito, tipo, anio)
{
var xmlhttp;
var cadena;
if (window.XMLHttpRequest)
...
xmlhttp.onreadystatechange=function()
  ...
  if(datos==1)  { cadena= "datos2013CC"; } else { cadena= "datos2013PP"; }
  
  
  
var url = cadena+".php?distrito="+distrito+"&seccion="+seccion+"&tipo="+tipo+"&anio=2012";
//alert(url);
xmlhttp.open("GET",url,true);
xmlhttp.send();
}