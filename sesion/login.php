...
<body>
    ...
    <div class="container">
        <div class="row">
            ...
            <br><br>
                <img class="img-circle img-responsive img-center" src="https://www.immobilienscout24.de/anbieter/resources_new/application/profilepage/team/profilbild_bb_avatar_275_275.png" alt="user">
                <br>
                <strong><h2>Bienvenido</h2></strong>
            </div>
            <div class="col-md-6">
