...
<br/>
    ...
    <input type="radio" name="radioEleccion" id="radioEleccion2" value="2">
    Jefe Delegacional &nbsp;&nbsp;
    <input type="radio" name="radioEleccion" id="radioEleccion3" value="3" checked>
    Diputado de Mayoria Relativa
<br/>
</div>
<br/>
...
<br/>
    ...
    <input type="radio" name="radioTipo" id="radioTipo2" value="2" onClick="javascript:changeText(2)">
    Delegacion &nbsp;&nbsp;
    <input type="radio" name="radioTipo" id="radioTipo3" value="3" onClick="javascript:changeText(3)">
    Distrito &nbsp;&nbsp;
    <input type="radio" name="radioTipo" id="radioTipo4" value="4" onClick="javascript:changeText(4)">
    Seccion
<br/>
</div>
<br/>
...
<div><h3>Opciones:</h3>
	<div> <!-- opciones -->
<br/>
	<div id="formulario" style="margin-left:20px; margin-right:20px;">
